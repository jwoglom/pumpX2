...
public class TandemConfig {
    ...
    public TandemConfig withUnbondAfterInitialConnectionHardFailuresCount(Integer count) {
        this.unbondAfterInitialConnectionHardFailuresCount = Optional.ofNullable(count);
        return this;
    }

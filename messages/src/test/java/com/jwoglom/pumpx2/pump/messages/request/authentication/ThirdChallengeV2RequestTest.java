...
public class ThirdChallengeV2RequestTest {
    // ./android-2024-02-29-6char2.csv
    @Test
    public void test_167cargo_thirdchallenge_split() throws DecoderException {
        ThirdChallengeV2Request expected = new ThirdChallengeV2Request(
                0,
                new byte[]{
        ...
        ThirdChallengeV2Request parsedReq = (ThirdChallengeV2Request) MessageTester.test(

...
public class PumpChallengeV2ResponseTest {
    ...
    public void test_167cargo_response_split() throws DecoderException {
        ...
        PumpChallengeV2Response expected = new PumpChallengeV2Response(
                0,
                new byte[]{
        ...
        PumpChallengeV2Response parsedReq = (PumpChallengeV2Response) MessageTester.test(

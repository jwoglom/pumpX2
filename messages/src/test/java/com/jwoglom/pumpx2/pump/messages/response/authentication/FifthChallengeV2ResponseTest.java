...
public class FifthChallengeV2ResponseTest {
    ...
    public void test_167cargo_5response_split() throws DecoderException {
        ...
        FifthChallengeV2Response expected = new FifthChallengeV2Response(
                0,
                new byte[]{-29,-3,50,80,-99,-6,-49,71,0,0,0,0,0,0,0,0,-48,65,8,86,-61,80,-50,107,-105,86,-32,56,16,-58,-7,-102,74,7,67,22,10,31,-37,9,115,-37,47,-112,-67,-55,-87,106}
        );

        FifthChallengeV2Response parsedReq = (FifthChallengeV2Response) MessageTester.test(

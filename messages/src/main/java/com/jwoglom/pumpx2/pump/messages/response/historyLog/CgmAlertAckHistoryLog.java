...
@HistoryLogProps(
    opCode = 173,
    displayName = "CGM Alert Ack",
    internalName = "LID_CGM_ALERT_ACK"
)
public class CgmAlertAckHistoryLog extends HistoryLog {

    private long alertId;
    private CGMAlertStatusResponse.CGMAlert alert;

    public CgmAlertAckHistoryLog() {}
    public CgmAlertAckHistoryLog(long pumpTimeSec, long sequenceNum, long alertId) {
    ...
    public CgmAlertAckHistoryLog(long pumpTimeSec, long sequenceNum, CGMAlertStatusResponse.CGMAlert alert) {
        this(pumpTimeSec, sequenceNum, alert != null ? alert.id() : 0);
        this.alert = alert;

    }

    public CgmAlertAckHistoryLog(long alertId) {
        this(0, 0, alertId);
    }

    public CgmAlertAckHistoryLog(CGMAlertStatusResponse.CGMAlert alert) {
        this(0, 0, alert);
    }

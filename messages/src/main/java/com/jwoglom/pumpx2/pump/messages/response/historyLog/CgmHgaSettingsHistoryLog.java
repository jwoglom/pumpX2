...
/**
 * CGM High Glucose Alert (HGA) settings change history log entry.
 *
...
@HistoryLogProps(
    opCode = 165,
    displayName = "CGM HGA Settings",
    internalName = "LID_CGM_HGA_SETTINGS"
)
public class CgmHgaSettingsHistoryLog extends HistoryLog {
    ...
    public CgmHgaSettingsHistoryLog() {}
    public CgmHgaSettingsHistoryLog(long pumpTimeSec, long sequenceNum, int alertLevel, int repeatDuration, boolean isEnabled, int modifiedField) {
    ...
    public CgmHgaSettingsHistoryLog(int alertLevel, int repeatDuration, boolean isEnabled, int modifiedField) {
    ...
    /**
     * @return whether the high glucose alert is enabled
     */

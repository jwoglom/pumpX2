...
/**
 * CGM Out Of Range (OOR) alert settings change history log entry.
 *
 * Fields parsed from the decompiled CgmGlucoseAlertSettingsModel:
 *   alertLevel   (raw[10-11]): uint16 - the alert threshold value
...
@HistoryLogProps(
    opCode = 169,
    displayName = "CGM OOR Settings",
    internalName = "LID_CGM_OOR_SETTINGS"
)
public class CgmOorSettingsHistoryLog extends HistoryLog {
    ...
    public CgmOorSettingsHistoryLog() {}
    public CgmOorSettingsHistoryLog(long pumpTimeSec, long sequenceNum, int alertLevel, int repeatDuration, boolean isEnabled, int modifiedField) {
    ...
    public CgmOorSettingsHistoryLog(int alertLevel, int repeatDuration, boolean isEnabled, int modifiedField) {
    ...
    /**
     * @return the out-of-range alert threshold value
     */
    ...
    /**
     * @return whether the out-of-range alert is enabled
     */

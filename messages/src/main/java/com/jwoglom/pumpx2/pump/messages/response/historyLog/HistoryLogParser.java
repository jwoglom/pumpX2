...
public class HistoryLogParser {
    ...
    public static final Set<Class<? extends HistoryLog>> LOG_MESSAGE_TYPES = Set.of(
        ...
        BolusIobEntryHistoryLog.class,
        IobSnapshotPreBolusHistoryLog.class,
        IobSnapshotPostBolusHistoryLog.class,
        BolusRequestedMsg1HistoryLog.class,
        BolusRequestedMsg2HistoryLog.class,
        BolusRequestedMsg3HistoryLog.class,
        InitiateBolusRequestMsg1HistoryLog.class,
        InitiateBolusRequestMsg2HistoryLog.class,
        BolusPermissionChangeHistoryLog.class,
        BolusPermissionResponseHistoryLog.class,
        InitiateBolusResponseHistoryLog.class,
        BolusPermissionRequestHistoryLog.class,
        InitiateBolusRequestMsg3HistoryLog.class,
        ...
        ReservoirEstimateHistoryLog.class,
        CartridgeFillResponseHistoryLog.class,
        PumpButtonHistoryLog.class,
        ...
        ControlRequestHistoryLog.class,
        ControlResponseHistoryLog.class,
        SetTempRateResponseHistoryLog.class,
        ...
        ChargingStartedHistoryLog.class,
        ChargingStoppedHistoryLog.class,
        BatteryHourlyHistoryLog.class,
        BatteryEstimateUpdateHistoryLog.class,
        ...
        BolusDeliverySummaryHistoryLog.class,
        BasalDeliveryHistoryLog.class,
        PumpDriveEventHistoryLog.class,

...
/**
 * This message is used as a paired request message for LoadCartridgeStateStreamResponse,
...
@MessageProps(
        ...
        response=LoadCartridgeStateStreamResponse.class,
        stream=true,
        signed=true
)
public class NonexistentLoadCartridgeStateStreamRequest extends Message {

    public NonexistentLoadCartridgeStateStreamRequest() {
        this.cargo = EMPTY;
    }

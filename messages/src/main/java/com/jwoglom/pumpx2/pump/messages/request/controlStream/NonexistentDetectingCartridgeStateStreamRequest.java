...
/**
 * This message is used as a paired request message for DetectingCartridgeStateStreamRequest,
...
public class NonexistentDetectingCartridgeStateStreamRequest extends Message {

    public NonexistentDetectingCartridgeStateStreamRequest() {
        this.cargo = EMPTY;
    }
